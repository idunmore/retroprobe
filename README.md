...
RetroProbe is built on a Raspberry Pi Pico, driving a 0.96" bit-color OLED 128x64 pixel I2C display, requires a pair of momentary switches, a male DE9 connector and a pair of 1MΩ resistors.
